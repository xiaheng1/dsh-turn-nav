window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region lib/types/client/TurnHistogramNav.js
		...
		function TurnHistogramNav({ useSession }) {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsx)("nav", {
					...
					"aria-label": "对话轮次导航",
					children: turns.map((turn, index) => (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("button", {
							...
							children: (0, react_jsx_runtime.jsx)("span", { className: TurnHistogramNav_module_css_default.bar })
