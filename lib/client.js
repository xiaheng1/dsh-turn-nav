	...
	factory: (require) => {
		...
		*/
		function TurnHistogramNav({ useSession }) {
			...
			const [focusedKey, setFocusedKey] = (0, react.useState)(null);
			const hoverTimerRef = (0, react.useRef)(void 0);
			const clearHoverTimer = () => {
				if (hoverTimerRef.current !== void 0) {
					window.clearTimeout(hoverTimerRef.current);
					hoverTimerRef.current = void 0;
				}
			};
			const scheduleMousePreview = (key) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("nav", {
					...
					"aria-label": "对话轮次导航",
					children: turns.map((turn, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: activeKey === turn.key ? `${TurnHistogramNav_module_css_default.item} ${TurnHistogramNav_module_css_default.active}` : TurnHistogramNav_module_css_default.item,
						"data-turn-nav-key": turn.key,
						onMouseEnter: () => {
							scheduleMousePreview(turn.key);
						},
						onMouseLeave: cancelMousePreview,
						onFocus: () => {
							handleFocus(turn.key);
						},
						onBlur: handleBlur,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							className: TurnHistogramNav_module_css_default.preview,
							role: "tooltip",
