window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function applyTurnNavConfig(patch) {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("nav", {
					...
					children: [turns.map((turn, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: isCodex ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: TurnHistogramNav_module_css_default.dot,
								style: { background: dotColorFor(turn.kind) }
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: TurnHistogramNav_module_css_default.bar })
						})
